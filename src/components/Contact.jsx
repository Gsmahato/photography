    ...
    return (
        <div className="w-full flex flex-wrap items-center">
            ...
            <div className='w-full md:w-1/2 lg:w-1/2 px-4 md:pl-14 md:pr-8 lg:pr-48 flex flex-col justify-center'>
                <h1 className='text-3xl md:text-4xl font-bold mb-6'>Send me a Message</h1>
                ...
                <div className='flex w-full justify-end'>
                    <button className="flex mt-4 px-6 py-3 justify-end items-end bg-gradient-to-r from-indigo-500 via-purple-500 to-green-500 text-white rounded-full uppercase shadow-md hover:from-purple-500 hover:to-green-500 focus:outline-none focus:ring focus:ring-purple-400 focus:ring-opacity-50">CONFIRM BOOKING
